...
export const UserEventsClient = () => {
  ...
  return (
    <div className="w-full">
      <div
        className={cn(
          userEvents.length > 0 && "flex justify-between items-center",
          "mb-6"
        )}>
        <h1 className="text-3xl font-bold text-secondary">Meus Eventos</h1>

        {userEvents.length > 0 && (
          <Link href="/user/events/new" className="inline-flex items-center">
            <Button>
      ...
      {userEvents.length === 0 && (
        <div className="flex flex-col items-center justify-center h-[400px]">
          ...
          <Link href="/user/events/new" className="mt-6">
            <Button>
              <PlusCircle className="size-5" />
